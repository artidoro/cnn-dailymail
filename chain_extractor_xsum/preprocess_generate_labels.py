...
def main():
    ...
    if not os.path.exists(args.ner_output_dir): os.makedirs(args.ner_output_dir)
    if not os.path.exists(args.contsel_output_dir): os.makedirs(args.contsel_output_dir)
